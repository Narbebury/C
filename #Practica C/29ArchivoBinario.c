...
void consulta()
{
    ...
    printf("Ingrese el codigo de producto a consular: ");
    int cod;
    scanf("%i", &cod);
    ...
    while (!feof(arch))
    {
        ...
        {
            printf("%i %s %0.2f", producto.codigo, producto.descripcion, producto.precio);
            existe = 1;
            break;
        }
        fread(&producto, sizeof(tproducto), 1, arch);
...
int main()
{
    ...
    do
    {
        ...
        printf("3 - Listado completo de prodcutos\n");
